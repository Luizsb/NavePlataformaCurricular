      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            title: "3ª série",
            description:
              "Objeto de conhecimento: Inovação e empreendedorismo\nCompetência: Empreender com inovação e impacto social, por meio da fabricação digital e da Inteligência Artificial aplicada.\nHabilidade: Analisar o papel das tecnologias digitais e da Inteligência Artificial no mundo do trabalho e na inovação social.\nHabilidade: Conhecer os fundamentos da Inteligência Artificial e utilizá-la para aprimorar produtos e processos criativos.\nHabilidade: Desenvolver MVPs (produtos mínimos viáveis) com fabricação digital, automação e Inteligência Artificial aplicada.\nHabilidade: Criar projetos de empreendedorismo, considerando sustentabilidade e ética tecnológica.",
          },
        ],
      },
    ],
