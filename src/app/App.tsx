    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "Explora o funcionamento das tecnologias digitais, a aplicação de princípios de design digital na criação de produtos e interfaces, e compreensão dos impactos da Inteligência Artificial.",
          },
          {
        ...
        items: [
          {
            title: "Design e Fabricação Digital",
            description:
              "Competência: Promover experiências em que as crianças explorem, criem e expressem ideias por meio da construção e transformação de materiais, compreendendo que o ato de fabricar é também uma forma de pensar, comunicar e resolver problemas.\nHabilidade: Explorar diferentes materiais e ferramentas (papel, blocos, argila, sucata, tecidos etc.) para representar ideias, histórias ou personagens.\nHabilidade: Experimentar diferentes formas de montagem, encaixe, recorte e colagem para criar objetos e estruturas, incluindo de fabricação digital.\nHabilidade: Testar, ajustar e reconstruir suas criações, demonstrando persistência e prazer em tentar novamente.\nHabilidade: Utilizar recursos tecnológicos simples (câmeras fotográficas, objetos de cortadora laser e impressoras 3D) como extensão do ato de criar.",
          },
        ],
      },
    ],
