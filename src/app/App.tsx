    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "Explora o funcionamento das tecnologias digitais, a aplicação de princípios de design digital na criação de produtos e interfaces, e compreensão dos impactos da IA.",
          },
          {
