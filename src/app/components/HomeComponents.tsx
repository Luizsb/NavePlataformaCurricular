        ...
        >
          ...
          <div className="mx-auto max-w-4xl text-left space-y-6">
            <p className="text-[16px] leading-relaxed text-zinc-600 font-medium">
              ...
              Society for Technology in Education (ISTE). Essa integração
              garante a progressão das aprendizagens previstas para a Educação
              Tecnológica, promovendo uma formação sólida, criativa e
              contemporânea.
            </p>
            <p className="text-[16px] leading-relaxed text-zinc-600 font-medium">
              ...
              e criar soluções inovadoras para problemas reais, utilizando
              tecnologias digitais, como inteligência artificial e computação
              criativa.
            </p>
            <p className="text-[16px] leading-relaxed text-zinc-600 font-medium">
              Mais do que acumular informações, aprender passa a significar
              criar, experimentar e refletir sobre o processo criativo. A
              proposta visa, portanto, à autonomia intelectual, à consciência
              ética e a capacidade de imaginar e realizar com propósito, unindo
        ...
        <ul className="space-y-4">
          {items.map((item, idx) => (
            <li key={idx} className="flex items-start gap-3">
              ...
              />
              <span className="text-[16px] font-bold text-zinc-600 leading-snug">
                {item}
              </span>
            </li>
          ))}
        ...
        <div className="space-y-8">
          {sections.map((section, sIdx) => (
            <div key={sIdx}>
              <h4
                className={cn(
                  "text-[10px] font-black uppercase tracking-[0.2em] mb-4 opacity-70",
