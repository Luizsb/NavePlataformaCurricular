import svgPaths from "./svg-eroniq0woz";
...
function Container() {
  return (
    <div className="absolute h-[6941.078px] opacity-8 overflow-clip right-0 top-0 w-[1534px]" data-name="Container">
      ...
      <div className="absolute flex h-[725.389px] items-center justify-center left-[-272.84px] top-[2517.64px] w-[962.695px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
...
function Container7() {
  return (
    <div className="absolute h-[642px] left-[438px] top-[15px] w-[578px]" data-name="Container">
      <Container8 />
      <div className="absolute flex h-[718.817px] items-center justify-center right-[-29.47px] top-[-54px] w-[623.471px]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
